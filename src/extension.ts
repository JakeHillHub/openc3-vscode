    ...
    vscode.window.withProgress(
      ...
      async () => {
        ...
        await Promise.all([
          ...
          pythonStubManager.initializeStubs(editorFileManager.getIgnoredDirPattern(), context),
          rubyStubManager.initializeStubs(editorFileManager.getIgnoredDirPattern(), context),
        ]);
